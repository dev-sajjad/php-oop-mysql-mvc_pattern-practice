        ...
        <div class="w-2/5  shadow-md p-5 bg-gray-200 border-2 rounded-xl">
            ...
            <form action="/submit-register" method="POST">
                <div class="w-full drop-shadow rounded-md p-4">
                    ...
                    <input class="appearance-none  border rounded-md  w-full py-3 px-4 text-xl text-grey-darker" value="<?php echo htmlspecialchars($user->name); ?>" name="name" id="name" type="text" placeholder="Your name" required>
                </div>
                <div class="w-full drop-shadow rounded-md p-4">
                    ...
                    <span class="block mt-1 text-red-600"><?php echo $user->error ?></span>
                </div>
                <div class="w-full drop-shadow rounded-md p-4">
